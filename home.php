    ...
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="dist/img/smkn3.png" class="user-image" alt="User Image">
                  <span class="hidden-xs"><?php echo $_SESSION['c_nama']?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="dist/img/smkn3.png" class="img-circle" alt="User Image">
                    <p>
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>KP.FST.UNISNU &copy;2016</b>
        </div>
        <strong>SMK N 3 JEPARA</strong>
      </footer>
